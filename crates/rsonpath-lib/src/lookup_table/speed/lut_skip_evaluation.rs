use super::lut_query_data::QUERY_GOOGLE;
...
fn evaluate(
    ...
    t_original /= QUERY_REPETITIONS as u64;
    t_original_skip /= QUERY_REPETITIONS as u64;
    let t_optimum = t_original - t_original_skip;
    t_lut /= QUERY_REPETITIONS as u64;
    t_lut_skip /= QUERY_REPETITIONS as u64;
