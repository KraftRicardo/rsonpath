...
static ACCUMULATED_SKIP_TIME_0: AtomicU64 = AtomicU64::new(0);
static ACCUMULATED_SKIP_TIME_64: AtomicU64 = AtomicU64::new(0);
static ACCUMULATED_SKIP_TIME_128: AtomicU64 = AtomicU64::new(0);
static ACCUMULATED_SKIP_TIME_192: AtomicU64 = AtomicU64::new(0);
static ACCUMULATED_SKIP_TIME_512: AtomicU64 = AtomicU64::new(0);
static ACCUMULATED_SKIP_TIME_1024: AtomicU64 = AtomicU64::new(0);
static ACCUMULATED_SKIP_TIME_2048: AtomicU64 = AtomicU64::new(0);
static ACCUMULATED_SKIP_TIME_8192: AtomicU64 = AtomicU64::new(0);
...
pub fn evaluate_rq_legacy_skip_time_speed(data_dir_path: &str, result_dir_path: &str) {
    println!("eval_legacy_skip_time_multi");
...
fn eval(data_dir_path: &str, results_dir_path: &str, query_data_csv: &str, use_count: bool) {
    ...
    for (query_id, query_text) in queries {
        ...
        if use_count {
            ...
            // Measurement
            ACCUMULATED_SKIP_TIME_0.store(0, Ordering::Relaxed);
            for _ in 0..QUERY_REPETITIONS {
        ...
        let skip_time_nano_seconds = ACCUMULATED_SKIP_TIME_0.load(Ordering::Relaxed) as f64 / QUERY_REPETITIONS as f64;
...
pub fn add_skip_time(added_time: u64) {
    ...
    ACCUMULATED_SKIP_TIME_0.fetch_add(added_time, Ordering::Relaxed);
    ACCUMULATED_SKIP_TIME_64.fetch_add(added_time, Ordering::Relaxed);
    ACCUMULATED_SKIP_TIME_128.fetch_add(added_time, Ordering::Relaxed);
    ACCUMULATED_SKIP_TIME_192.fetch_add(added_time, Ordering::Relaxed);
}
